...
const chatGPTimageDefaultOptions = new Menu<BotContext>(MenuIds.CHAT_GPT_MODEL)
  ...
  .text((ctx) => `${getLabel(ChatGPTModelsEnum.GPT_4, ctx)}`, (ctx) => setModel(ChatGPTModelsEnum.GPT_4, ctx))
  .text((ctx) => `${getLabel(ChatGPTModelsEnum.GPT_4_32K, ctx)}`, (ctx) => setModel(ChatGPTModelsEnum.GPT_4_32K, ctx))
  .row()
  .text((ctx) => `${getLabel(ChatGPTModelsEnum.GPT_35_TURBO, ctx)}`, (ctx) => setModel(ChatGPTModelsEnum.GPT_35_TURBO, ctx))
  .text((ctx) => `${getLabel(ChatGPTModelsEnum.GPT_35_TURBO_16K, ctx)}`, (ctx) => setModel(ChatGPTModelsEnum.GPT_35_TURBO_16K, ctx))
  .row()
  .back("Back");
